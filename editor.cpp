...
class Line {
		...
		newNode->next = NULL;
		newNode->prev = NULL;
		//point head, tail, cursor at new node
		head = newNode;
		tail = newNode;
		cursor = newNode;
        }

        // same as above, but load str into the list also, using add
        void add(string str) {
		//loop to add every character of the string
        ...
        // add an entire other line (pointed to by oldHead) to the tail of this line
